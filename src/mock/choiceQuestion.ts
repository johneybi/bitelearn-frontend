...
export const MOCK_CHOICE_QUESTION_SET: ChoiceQuestionSet = {
  ...
  questions: [
    ...
    // ────────────────────────────────────────────────────────
    {
      ...
      imageAlt: '강아지 일러스트',
      question:
        '중개사의 말만 믿고 등기부등본을 확인하지 않아도 계약은 안전하다.',
      choices: ['O', 'X'],
      correctIndex: 1,
      explanation:
        "무조건 틀렸습니다! 중개사의 말이 아니라 '등기사항전부증명서(등기부등본)'를 직접 떼어서 진짜 주인과 빚의 상태를 눈으로 확인해야 합니다.",
    },
    {
      questionNumber: 7,
      type: 'quiz',
      ...
      question:
        "등기부등본에서 소유자(진짜 주인)는 '갑구', 근저당권(빚)은 '을구'에서 확인할 수 있다.",
      choices: ['O', 'X'],
      correctIndex: 0,
      explanation:
        '정답입니다! 갑구에는 소유권(진짜 주인)이, 을구에는 근저당권(은행 빚) 등 소유권 이외의 권리가 적혀 있습니다. 이 두 곳을 꼭 확인하세요!',
    },
    ...
    // ────────────────────────────────────────────────────────
    {
      ...
      imageAlt: '계산기와 서류',
      question:
        '집값 3억, 채권최고액 2억 4천만 원, 보증금 8천만 원. 이 집에 전세로 들어가도 안전할까요?',
      choices: [
    ...
    // 타입 1: 서류 UI의 요소를 직접 터치해서 정답을 고르는 문제 (document_select)
    {
      ...
      flavorText:
        "이 서류에서 당장 계약을 멈춰야 하는 가장 위험한 '부분'을 찾아 눌러보세요!",
      documentCard: {
        ...
        footerNotice:
          '본 문서는 학습용 가상 서류입니다. 개인정보는 포함되어 있지 않습니다.',
      },
      imageUrl: '',
      imageAlt: '',
      ...
      explanation:
        "정답입니다! 갑구에 '가압류'가 있다는 것은 집이 강제로 넘어갈 위기라는 뜻입니다. 서류에서 이 단어를 발견하면 뒤도 돌아보지 말고 피하세요.",
    },
    ...
    // 타입 2: 서류 UI를 지문으로 보고 하단 객관식을 고르는 문제 (multiple)
    {
      ...
      imageAlt: '',
      question:
        "불독 아저씨가 '내가 원래 주인이니까 나랑 계약해'라고 합니다. 서류를 본 멍멍이의 올바른 해석은?",
      choices: [
      ...
      correctIndex: 1,
      explanation:
        '신탁회사가 관리하는 집은 소유권이 신탁회사에 넘어간 상태입니다. 반드시 신탁회사의 서면 동의서가 있거나 신탁회사와 직접 계약해야 보증금을 지킬 수 있습니다.',
    },
    {
      questionNumber: 12,
      type: 'quiz',
      ...
      flavorText:
        "불독: '나 5천만 원 갚아서 이제 빚 2억 5천만 원이야! 영수증 봐봐~'",
      imageUrl: '',
      imageAlt: '',
      question:
        '불독 아저씨의 말을 듣고, 내 보증금이 안전할지 따져볼 때 기준으로 삼아야 할 빚 금액은?',
      choices: [
      ...
      correctIndex: 2,
      explanation:
        "은행 이자 영수증이나 구두 약속은 법적 효력이 없습니다. 집이 경매에 넘어가면 은행은 등기부등본에 적힌 '채권최고액'만큼 1순위로 가져가므로, 이 3억 원 전체를 빚으로 보수적으로 계산해야 안전합니다.",
    },
    ...
    // ────────────────────────────────────────────────────────
    {
      ...
      conversationSpeakers: [
        ...
        },
        {
          ...
          position: 'left',
          profileImageUrl:
            'https://images.unsplash.com/photo-1544568100-847a948585b9?auto=format&fit=crop&w=100&q=80',
        },
      ],
      conversations: [
        {
          ...
          speakerId: 'pug',
          message:
            '어휴 숨차. 우리 형(불독)이 오늘 바쁘다고 해서 내가 대신 계약하러 왔어~',
        },
        {
          id: 'c2',
          speakerId: 'me',
          message: '네? 집주인 아저씨가 안 오셨다고요?',
        },
        {
          id: 'c3',
          speakerId: 'pug',
          message:
            '응응, 형이 나한테 다 알아서 하라고 했어. 가족이니까 그냥 나랑 쓰자!',
        },
      ],
      imageUrl: '',
      imageAlt: '',
      question:
        '진짜 집주인 대신 동생인 퍼그 아저씨가 나왔습니다. 멍멍이가 당당하게 요구해야 할 서류 두 가지는?',
      choices: [
      ...
      correctIndex: 1,
      explanation:
        "아무리 가까운 가족이라도 법적인 대리인이 되려면 집주인의 인감도장이 찍힌 '위임장'과 '본인발급 인감증명서'가 반드시 있어야 합니다.",
    },
    {
      questionNumber: 14,
      type: 'quiz',
      ...
      conversations: [
        {
          id: 'c1',
          speakerId: 'broker',
          message: '자, 이제 특약사항 다 적었고 도장 찍읍시다!',
        },
        {
          id: 'c2',
          speakerId: 'me',
          message:
            '아저씨, 저 은행에서 전세대출 받아서 잔금 치를 건데요. 만약에 대출 안 해주면 제 계약금은 어떻게 돼요?',
        },
        {
          id: 'c3',
          speakerId: 'broker',
          message: '에이~ 그럴 일 없어. 학생 관상이 딱 대출 프리패스 상이네!',
        },
      ],
      imageUrl: '',
      imageAlt: '',
      question:
        "중개사의 말을 무시하고, 계약서 맨 밑 특약사항에 꼭 적어달라고 해야 하는 '마법의 문구'는?",
      choices: [
      ...
      correctIndex: 0,
      explanation:
        '전세대출은 은행 심사 전까지 100% 확신할 수 없습니다. 대출 거절 시 피 같은 계약금을 잃지 않으려면 이 특약을 반드시 한 글자도 빠짐없이 넣어야 합니다.',
    },
    {
      questionNumber: 15,
      type: 'quiz',
      ...
      conversations: [
        {
          id: 'c1',
          speakerId: 'me',
          message: '휴, 서류 확인 다 끝났습니다. 이제 계약금 보낼게요.',
        },
        {
          id: 'c2',
          speakerId: 'pug',
          message:
            '아이고 잘 생각했어! 근데 형이 지금 은행앱 점검 시간이라 확인이 안 된대.',
        },
        {
          id: 'c3',
          speakerId: 'pug',
          message:
            '그러니까 일단 여기 내(퍼그) 통장으로 입금해 줘. 내가 형한테 이따 줄게.',
        },
      ],
      conversationInfoBox: {
        title: '입금 직전 주의사항',
      ...
      imageAlt: '',
      question:
        '대리인 퍼그 아저씨가 자기 통장으로 입금하라고 유도합니다. 멍멍이의 올바른 대처법은?',
      choices: [
      ...
      correctIndex: 1,
      explanation:
        "하늘이 두 쪽 나도 계약금과 보증금은 무조건 '등기부등본 갑구에 적힌 진짜 소유자 명의 통장'으로만 입금해야 법적인 보호를 받습니다. 대리인이나 중개사 통장으로 보내면 안 됩니다.",
    },
    {
      questionNumber: 16,
      type: 'quiz',
      ...
      conversations: [
        {
          id: 'c1',
          speakerId: 'other',
          message: '그런데 학생. 혹시 전입신고 할 생각이에요?',
        },
        { id: 'c2', speakerId: 'me', message: '네, 그러려고요. 왜요?' },
        {
          ...
          speakerId: 'other',
          message:
            '전입신고 안 할수는 없을까? 세금이랑 건강보험 때문에 그래. 학생한테 부탁좀 할게.',
        },
        {
          id: 'c4',
          speakerId: 'other',
          message: '대신 월세 5만원 깎아줄게요. 학생, 그렇게 해줄거지?',
        },
      ],
      conversationInfoBox: {
        title: '전입신고를 거부하는 경우',
        content:
          '전입신고를 하지 않으면, 대항력과 우선변제권을 상실해서 보증금을 통째로 날릴 수도 있어요.',
      },
      imageUrl: '',
      imageAlt: '',
      question:
        '집주인이 전입신고를 하지 말라고 부탁할 때 가장 올바른 대처법은?',
      choices: [
      ...
      correctIndex: 1,
      explanation:
        '전입신고와 확정일자는 주택임대차보호법의 보호를 받기 위한 필수 생명줄입니다. 어떠한 경우라도 전입신고를 하지 않는 조건의 계약은 피해야 합니다. 당장 도망치세요!',
    },
  ],
};
